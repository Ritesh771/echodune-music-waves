    ...
    <div className="flex items-center justify-center min-h-screen bg-spotify-black">
      <div className="w-full max-w-md p-8 space-y-8 bg-spotify-gray rounded-2xl shadow-2xl border border-spotify-dark/40">
        <div className="flex flex-col items-center mb-6">
          ...
          <span className="text-spotify-green font-semibold tracking-wider text-lg">Create your account</span>
        </div>
        <motion.form
          className="space-y-6"
        ...
        >
          ...
          <div>
            <label htmlFor="email" className="text-sm font-medium text-spotify-lightgray">
              Email
            </label>
            <input
              id="email"
        ...
        <div className="text-center mt-4">
          <span className="text-spotify-lightgray">Already have an account? </span>
          <button className="text-spotify-green hover:underline" onClick={() => navigate('/login')}>Sign in</button>
        </div>
      </div>
    </div>
  );
